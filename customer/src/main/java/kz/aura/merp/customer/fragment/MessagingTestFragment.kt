...
import kz.aura.merp.customer.data.model.Notification
import kz.aura.merp.customer.data.model.PushNotification
import kz.aura.merp.customer.service.NotificationApi
import kz.aura.merp.customer.service.ServiceBuilder
import kz.aura.merp.customer.util.Constants.BASE_URL
...
class MessagingTestFragment : Fragment() {
    ...
    private fun sendNotification(notification: PushNotification) = CoroutineScope(Dispatchers.IO).launch {
        try {
            val apiService = context?.let { ServiceBuilder.buildService(NotificationApi::class.java, it, BASE_URL) }
